package com.cg.parallelproject1.controller;
...
import com.cg.parallelproject1.service.CustomerServiceImpl;
import com.cg.parallelproject1.service.TransactionService;
import com.cg.parallelproject1.service.TransactionServiceImpl;
...
// for checking the balance
	...
	int balance=	customer.getBalance();
		...
		modelAndView.addObject("CUSTOMER", balance);
		return modelAndView;
	}
...
//manager login
	...
	public ModelAndView ManagerLogin(@RequestParam String name, @RequestParam String password) {
		...
		if (a.equals("apoorv") && b.equals("apoorv1234")) {
...
//fund transferS
	...
	public ModelAndView FundTransfer(@RequestParam Integer id, @RequestParam Integer money) {
		...
		if (Senderbalance - sendingmoney < 0) {
			...
			modelAndView.addObject("TRANSFERDETAIL", sender);
			return modelAndView;
		}
	}
}
